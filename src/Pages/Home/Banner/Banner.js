  ...
  return (
    <div className="carousel w-full banner-container">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        <button className=" banner-btn   text-white   w-52 mr-5">Discover More</button>
        <button className=" banner-btn  text-white  w-52">Latest Project</button>
        </div>

        <div className="absolute justify-end flex  transform -translate-y-1/2 right-5 bottom-0 ">
          <a href="#slide4" className="btn btn-circle mr-6 hover:bg-red-700 ">
            <FaArrowLeft />
          </a>
          <a href="#slide2" className="btn btn-circle  hover:bg-red-700">
            <FaArrowRight />
          </a>
        </div>
      </div>
